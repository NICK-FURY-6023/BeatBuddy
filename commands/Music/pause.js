    ...
    sameVoiceChannel: true,
	 execute: async (message, args, client, prefix) => {
        ...
        const song = player.queue.current;
           ...
           const But1 = new MessageButton().setCustomId("vdown").setEmoji("<:galaxyvolume_up:1044373079532507236>").setStyle("SECONDARY");
...
try{
    player.get('nowplayingMSG').edit({components: []})
    }catch(e) {
}    
        return message.react("<:pause:996039702736011385>");
